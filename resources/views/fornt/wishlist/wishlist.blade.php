        ...
        <div class="order-detail-content">
         ...
         $productinfo = DB::table('tproducts')->where('id', $whishlist->product_id)->first();
                        ...
                        <td class="price">
                            ...
                            <td >
                            <a  href="/addTocart/{{$productinfo->id}}" class="btn btn-info"><span>Add to Cart</span></a>
                            </td>
                            <td >
                            <a  href="/wishlist/item/delete/{{$productinfo->id}}" class="btn btn-danger"><span>Remove</span></a>
                            </td>
                        </tr>
                    <?php 
