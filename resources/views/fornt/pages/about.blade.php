			...
			<div class="terms">
				...
				<div class="ser-t">
					...
					<div class="ter-wthree">
						<h6 class="text text-center"><span></span>Healthpharm.com.bd is the online gateway to your favorite medical store</h6>
						
					</div>
<br>
					<div class="ter-wthree">
						<h6><span></span>Mission: </h6>
						<ol start="1">
                       <p> 1. Any kind of Medicines are available for Remote area with Reasonable Price.</p>
                        <p>2. Medical equipment and surgical items are also available.</p>
                       <p> 3. Offering mobile nursing services.</p>
                        <p>4. Creating awareness about vaccine.</p>
                        <p>5. Create awareness among people with health message every day by Social Media.</p>
							
						</ol>
					</div>
					<br>
                    <div class="ter-wthree">
						<h6><span></span>In emergency we are available for you: </h6>
						<ol start="1">
                       <p> We have our own drug license (License No: DC-17093) by,  Directorate General of Drug Administration (DGDA) under the Bengal drugs rules 1946 and we are active member of e-commerce association of Bangladesh(e-Cab, member no: 00). We have registered & reliable pharmacy stores and shops nation-wide so you can order from us with confidence.</p>
