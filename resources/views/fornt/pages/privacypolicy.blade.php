...
<div class="ter-wthree">
						<h6><span></span> </h6>
						<ol start="1">
                        <p>Welcome to Healthpharma.com.bd. We respect you privacy and want to protect your personal information.
                    ...
                    <div class="ter-wthree">
						<h6><span></span>1. Information we collect: </h6>
						<ol start="1">
                    ...
                    <div class="ter-wthree">
						<h6><span></span>2. How we use your information </h6>
						<ol start="1">
                        <p>
                        Our website uses the data. We collect for three basic purposes: </p>
                        <p>•	To operate our business and provide (including improving and personalizing) the services we offer.</p>
                       <p> •	To send communications, including promotional communications.</p>
                        <p>•	To display advertising.</p>
                          <p>  In carrying out these purposes, we combine data we collect to give you a more seamless, consistent and personalized experience. However, to enhance privacy, we have built in technological and procedural safeguards designed to prevent certain data combinations.
                            For example, we store data we collect from you when you are unauthenticated (not signed in) separately from any account information that directly identifies you, such as your name, E-mail address or phone number.
</p>
                    ...
                    <div class="ter-wthree">
						<h6><span></span>3. Sharing your information</h6>
						<ol start="1">
                        <p>We do NOT share your information with anyone, including data collected through our website. However, we can NOT be responsible for the data that search engines, like Google, collects when you arrive to our website through such paths.
                    </p>
                    ...
                    <div class="ter-wthree">
						<h6><span></span>6. Questions?</h6>
						<ol start="1">
                        <p>
                        Please contact us regarding any questions regarding this statement.
						</p>
                        <p>
                        <strong>N.B. Our privacy policy is subject to change at any time without notice.</strong>
                        </p>
                        </ol>
					</div>
