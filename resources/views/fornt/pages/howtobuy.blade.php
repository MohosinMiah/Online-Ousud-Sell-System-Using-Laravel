...
<div class="ter-wthree">
						<h6><span>How to buy</span> </h6>
						<ol start="1">
                        <p>1.	If you are visiting our site for the first time, please do ‘sign up’ and create your own ‘Username and Password’.</p>
                        <p>2.	Click on the product you want to buy then go the product description and click on ‘Buy Now’.</p> 
                        <p>3.	It will require your username and password to log in, once you log in it will direct you to the product you have chosen. </p>
                        <p>4.	place your order</p>
                        <p>5.	Within short time our representative will contact you over the phone.</p>
                        <p>6.	For ordering over the phone call on 01_ _ _ _ _  imo, WhatsApp, Viber, Line  (24 hours available).</p>


						</ol>
					</div>
                    <div class="ter-wthree">
						<h6><span>How to Payment:</span> </h6>
						<ol start="1">
                        <h4 class="text text-center text-primary"><strong>Global Payments Processing</strong></h4>
                        <p>Accept all global Debit, Credit card, Mobile Banking and PayPal payments from customers using these currencies.</p>
                            <p>e.g. VISA, MasterCard, AmericanExpress, Discover, PayPal, UCB
                            </p> 
