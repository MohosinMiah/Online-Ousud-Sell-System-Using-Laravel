...
@section('content')
   ...
   @endif
         ...
         <div class="box-border">
                       <form action="{{route('register_guest_customer_shipping_info')}}" method="POST">
                       {{ csrf_field() }}
                       <ul>
                       <li class="row">
                                <div class="col-sm-6">
                                    <label for="name" class="required">Name</label>
                                    <input class="input form-control" name="name" value="{{old('name')}}" required id="name" type="text">
                                </div>
                                <div class="col-sm-6">
                                    <label for="email" class="required">Email</label>
                                    <input name="email" class="input form-control" value="{{old('email')}}" required id="email" type="email">
                                </div>
                            </li>
                             <li class="row">
                                <div class="col-sm-6">
                                    <label for="house" class="required">House</label>
