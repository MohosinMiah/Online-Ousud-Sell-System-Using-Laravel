...
if (!empty($corporate_orders)) { ?>
    ...
    <table id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 972px;">
                      <thead>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 56px;" aria-label="Created At: activate to sort column ascending">Address  </th>
                    
                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 56px;" aria-label="Created At: activate to sort column ascending">Requirements  </th>
                     ...
                     <tr role="row" class="odd">
                        ...
                        <td tabindex="0" class="sorting_1">{{$corporate_order->id}}</td>
                          ...
                          <td>{{$corporate_order->address}} </td>
                          
                          <td>{{$corporate_order->details}} </td>
                          
                          <td>{{date('D-M-Y', strtotime($corporate_order->created_at))}} </td>
